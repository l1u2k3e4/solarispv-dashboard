 ...
 *
 * Wird auf Admin-/Studio-Routes ausgeblendet (kein Chatbot in der Lead-Inbox
 * oder im Sanity Studio).
 */
  ...
  return (
    <div className="fixed right-6 bottom-6 z-40 hidden flex-col gap-3 lg:flex">
      ...
      <a
        ...
        className="flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-xl transition-transform hover:scale-105 motion-reduce:transition-none motion-reduce:hover:scale-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366] focus-visible:ring-offset-2"
      >
        <svg
          viewBox="0 0 24 24"
          fill="currentColor"
